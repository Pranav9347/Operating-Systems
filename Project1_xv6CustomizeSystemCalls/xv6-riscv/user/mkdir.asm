...
main(int argc, char *argv[])
{
  ...
  40:	8c458593          	addi	a1,a1,-1852 # 900 <malloc+0xfe>
  44:	4509                	li	a0,2
  46:	6de000ef          	jal	724 <fprintf>
    exit(1);
  4a:	4505                	li	a0,1
  4c:	2ea000ef          	jal	336 <exit>
      fprintf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	6090                	ld	a2,0(s1)
  52:	00001597          	auipc	a1,0x1
  56:	8c658593          	addi	a1,a1,-1850 # 918 <malloc+0x116>
  5a:	4509                	li	a0,2
  5c:	6c8000ef          	jal	724 <fprintf>
      break;
    }
  }
...
stat(const char *n, struct stat *st)
{
 ...
 1b8:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1ba:	85ca                	mv	a1,s2
 1bc:	1d2000ef          	jal	38e <fstat>
 1c0:	892a                	mv	s2,a0
  close(fd);
 1c2:	8526                	mv	a0,s1
 1c4:	19a000ef          	jal	35e <close>
  return r;
 1c8:	64a2                	ld	s1,8(sp)
}
 1ca:	854a                	mv	a0,s2
...
00000000000002c8 <syscall>:

// Trap into kernel space for system calls
int syscall(int num, ...) {
 2c8:	7175                	addi	sp,sp,-144
 2ca:	e4a2                	sd	s0,72(sp)
 2cc:	0880                	addi	s0,sp,80
 2ce:	832a                	mv	t1,a0
 2d0:	e40c                	sd	a1,8(s0)
 2d2:	e810                	sd	a2,16(s0)
 2d4:	ec14                	sd	a3,24(s0)
 2d6:	f018                	sd	a4,32(s0)
 2d8:	f41c                	sd	a5,40(s0)
 2da:	03043823          	sd	a6,48(s0)
 2de:	03143c23          	sd	a7,56(s0)
    uint64 args[6];
    va_list ap;
    int i;
    ...
    va_start(ap, num);
 2e2:	00840793          	addi	a5,s0,8
 2e6:	faf43c23          	sd	a5,-72(s0)
    for (i = 0; i < 6; i++) {
 2ea:	fc040793          	addi	a5,s0,-64
 2ee:	ff040613          	addi	a2,s0,-16
        args[i] = va_arg(ap, uint64);
 2f2:	fb843703          	ld	a4,-72(s0)
 2f6:	00870693          	addi	a3,a4,8
 2fa:	fad43c23          	sd	a3,-72(s0)
 2fe:	6318                	ld	a4,0(a4)
 300:	e398                	sd	a4,0(a5)
    for (i = 0; i < 6; i++) {
 302:	07a1                	addi	a5,a5,8
 304:	fec797e3          	bne	a5,a2,2f2 <syscall+0x2a>
    }
    va_end(ap);

    // Place the system call number in a7, arguments in a0-a5
    register uint64 a0 asm("a0") = args[0];
 308:	fc043503          	ld	a0,-64(s0)
    register uint64 a1 asm("a1") = args[1];
 30c:	fc843583          	ld	a1,-56(s0)
    register uint64 a2 asm("a2") = args[2];
 310:	fd043603          	ld	a2,-48(s0)
    register uint64 a3 asm("a3") = args[3];
 314:	fd843683          	ld	a3,-40(s0)
    register uint64 a4 asm("a4") = args[4];
 318:	fe043703          	ld	a4,-32(s0)
 ...
 322:	00000073          	ecall
    ...
    return a0;
 326:	2501                	sext.w	a0,a0
 328:	6426                	ld	s0,72(sp)
 32a:	6149                	addi	sp,sp,144
 32c:	8082                	ret
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6fa:	24290913          	addi	s2,s2,578 # 938 <malloc+0x136>
        for(; *s; s++)
