...
forktest(void)
{
  ...
  36:	41650513          	addi	a0,a0,1046 # 448 <uptime+0xa>
  ...
  58:	44450513          	addi	a0,a0,1092 # 498 <uptime+0x5a>
  5c:	fa5ff0ef          	jal	0 <print>
    exit(1);
  60:	4505                	li	a0,1
  62:	344000ef          	jal	3a6 <exit>
      exit(0);
  66:	340000ef          	jal	3a6 <exit>
  }
  ...
  6e:	3ee50513          	addi	a0,a0,1006 # 458 <uptime+0x1a>
  72:	f8fff0ef          	jal	0 <print>
      exit(1);
  76:	4505                	li	a0,1
  78:	32e000ef          	jal	3a6 <exit>
    }
  }
  ...
  80:	3f450513          	addi	a0,a0,1012 # 470 <uptime+0x32>
  84:	f7dff0ef          	jal	0 <print>
    exit(1);
  88:	4505                	li	a0,1
  8a:	31c000ef          	jal	3a6 <exit>
  for(; n > 0; n--){
  8e:	00905963          	blez	s1,a0 <forktest+0x7a>
    if(wait(0) < 0){
  92:	4501                	li	a0,0
  94:	31a000ef          	jal	3ae <wait>
  ...
  b0:	3dc50513          	addi	a0,a0,988 # 488 <uptime+0x4a>
...
stat(const char *n, struct stat *st)
{
 ...
 228:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 22a:	85ca                	mv	a1,s2
 22c:	1d2000ef          	jal	3fe <fstat>
 230:	892a                	mv	s2,a0
  close(fd);
 232:	8526                	mv	a0,s1
 234:	19a000ef          	jal	3ce <close>
  return r;
 238:	64a2                	ld	s1,8(sp)
}
 23a:	854a                	mv	a0,s2
...
0000000000000338 <syscall>:

// Trap into kernel space for system calls
int syscall(int num, ...) {
 338:	7175                	addi	sp,sp,-144
 33a:	e4a2                	sd	s0,72(sp)
 33c:	0880                	addi	s0,sp,80
 33e:	832a                	mv	t1,a0
 340:	e40c                	sd	a1,8(s0)
 342:	e810                	sd	a2,16(s0)
 344:	ec14                	sd	a3,24(s0)
 346:	f018                	sd	a4,32(s0)
 348:	f41c                	sd	a5,40(s0)
 34a:	03043823          	sd	a6,48(s0)
 34e:	03143c23          	sd	a7,56(s0)
    uint64 args[6];
    va_list ap;
    int i;
    ...
    va_start(ap, num);
 352:	00840793          	addi	a5,s0,8
 356:	faf43c23          	sd	a5,-72(s0)
    for (i = 0; i < 6; i++) {
 35a:	fc040793          	addi	a5,s0,-64
 35e:	ff040613          	addi	a2,s0,-16
        args[i] = va_arg(ap, uint64);
 362:	fb843703          	ld	a4,-72(s0)
 366:	00870693          	addi	a3,a4,8
 36a:	fad43c23          	sd	a3,-72(s0)
 36e:	6318                	ld	a4,0(a4)
 370:	e398                	sd	a4,0(a5)
    for (i = 0; i < 6; i++) {
 372:	07a1                	addi	a5,a5,8
 374:	fec797e3          	bne	a5,a2,362 <syscall+0x2a>
    }
    va_end(ap);

    // Place the system call number in a7, arguments in a0-a5
    register uint64 a0 asm("a0") = args[0];
 378:	fc043503          	ld	a0,-64(s0)
    register uint64 a1 asm("a1") = args[1];
 37c:	fc843583          	ld	a1,-56(s0)
    register uint64 a2 asm("a2") = args[2];
 380:	fd043603          	ld	a2,-48(s0)
    register uint64 a3 asm("a3") = args[3];
 384:	fd843683          	ld	a3,-40(s0)
    register uint64 a4 asm("a4") = args[4];
 388:	fe043703          	ld	a4,-32(s0)
 ...
 392:	00000073          	ecall
    ...
    return a0;
 396:	2501                	sext.w	a0,a0
 398:	6426                	ld	s0,72(sp)
 39a:	6149                	addi	sp,sp,144
 39c:	8082                	ret
